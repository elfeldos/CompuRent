...
Computer.create!(name: 'MacBookAir', image: 'https://store.storeimages.cdn-apple.com/4668/as-images.apple.com/is/macbook-air-og-202011?wid=600&hei=315&fmt=jpeg&qlt=95&.v=1604278672000', category: 'Laptop', year: '2019', details: 'Heavily used', availiability: 'true', price:'72.99', user: johanna)
...
Computer.create!(name: 'ASUS ROG Zephyrus G14', image: 'https://www.notebookcheck.nl/uploads/tx_nbc2/ASUSZephyrusG14-GA401IU__2__02.jpg', category: 'Laptop', year: '2020', details: 'Beeldscherm: 14 inch (2560 x 1440)', availiability: 'true', price:'35.99', user: freddy)
Computer.create!(name: 'iMac', image: 'https://www.icreatemagazine.nl/app/uploads/2021/04/imac-2021-nieuw.jpg', category: 'PC', year: '2019', details: 'Great shape!', availiability: 'true', price:'53.99', user: freddy)
Computer.create!(name: 'Asus Zenbook', image: 'https://www.notebookcheck.nl/uploads/tx_nbc2/teaser_53.jpg', category: 'Laptop', year: '2016', details: 'Great graphics', availiability: 'true', price:'16.99', user: johanna)
...
Computer.create!(name: 'HP Zephyrus G17', image: 'https://www.hp.com/nl-nl/shop/Html/Merch/Images/c07962991_1750x1285.jpg', category: 'PC', year: '2020', details: 'Beeldscherm: 21 inch', availiability: 'true', price:'35.99', user: freddy)
puts "done!"
